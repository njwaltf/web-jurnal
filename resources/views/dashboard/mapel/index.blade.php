...
@section('main')
    ...
    @if (auth()->user()->role === 'Admin')
        <div class="row">
            <div class="col-md-2">
                {{-- btn add --}}
                <a class="btn btn-info my-3" href="/dashboard/mapel/create">Tambah Mapel <i class="ti ti-plus"></i></a>
            </div>
            <div class="col-md-2">
                {{-- btn add --}}
                <a class="btn btn-info my-3" href="{{ url('/mapel/export') }}">Export Data PDF <i
            ...
            <div class="col-lg-12 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body p-4">
                        <h5 class="card-title fw-semibold mb-4">Daftar Mapel</h5>
                                        ...
                                        @forelse ($mapels as $mapel)
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    ...
                                                    <a href="/dashboard/mapel/{{ $mapel->id }}/edit"

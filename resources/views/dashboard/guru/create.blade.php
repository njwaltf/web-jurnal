...
@section('main')
    ...
    <div class="row">
        <div class="col-lg-12 my-3">
            <h2><a href="/dashboard/teacher"><i class="ti ti-arrow-left"></i></a> Tambah Guru</h2>
        </div>
    </div>
    <form action="/dashboard/teacher" method="post">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('teacher_name') is-invalid @enderror"
                                        id="teacher_name" name="teacher_name" value="{{ old('teacher_name') }}">
                                    @error('teacher_name')
        ...
        <div class="row">
            <div class="col-lg-3">
                <button type="submit" class="btn btn-primary" style="margin-right: 15px">Tambah Guru <i
